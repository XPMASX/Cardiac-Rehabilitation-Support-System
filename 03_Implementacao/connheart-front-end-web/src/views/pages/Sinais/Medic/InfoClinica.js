...
import IconClinica from '../../../../assets/images/icons/Branco/Icones_Branco-07.svg';
...
function InfoClinica({ isLoading, imageIcon, text1, text2, className }) {
            ...
            {isLoading ? (
                ...
                <CardWrapper content={false}>
                    <Card sx={{ display: 'flex', width: '100%', height: '100%' }}>
                        ...
                        >
                            <img src={IconClinica} alt="icon" style={{ width: '45%', height: '65%' }} />
                        </Box>
                        <Box
                            sx={{
                                display: 'flex',
